...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            float gpuUsage = -1, gpuPower = -1, usedVram = -1, totalVram = -1;
            ...
            if (gpu != null)
                foreach (var s in gpu.Sensors)
                {
                    ...
                    else if (s.Name == "GPU Package")
                        gpuPower = s.Value.GetValueOrDefault();
                    ...
                    if (gpuUsage != -1 && gpuPower != -1 && usedVram != -1 && totalVram != -1) break;
                }
